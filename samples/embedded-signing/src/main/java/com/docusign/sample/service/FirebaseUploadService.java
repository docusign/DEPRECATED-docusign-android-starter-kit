...
import com.docusign.sample.LoginActivity;
 ...
 */
public class FirebaseUploadService extends FirebaseTaskService {
    ...
    public void uploadFromUri(final Uri fileUri) {
        ...
        // [START get_child_ref]
        // Get a reference to store file at documents/FILENAME
        final StorageReference documentsRef = FirebaseStorage.getInstance().getReferenceFromUrl(Config.FIREBASE_STORAGE_URL + "/documents/" + fileUri.getLastPathSegment());
        // [END get_child_ref]

        // Upload file to Firebase Storage
        documentsRef.putFile(fileUri).
    ...
    private void showUploadFinishedNotification(@Nullable Uri downloadUrl, @Nullable Uri fileUri) {
        ...
        String caption = "Upload successfull!";
